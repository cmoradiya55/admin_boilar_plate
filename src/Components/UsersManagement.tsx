  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        actions={
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5">
      ...
      >
        ...
        <TabsContent value={activeTab} className="space-y-6">
          ...
          >
            <div className="overflow-x-auto">{getTabContent()}</div>
          </DataTableWrapper>
        </TabsContent>
      </Tabs>
    </div>
